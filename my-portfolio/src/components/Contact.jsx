...
const Contact = () => {
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-2">
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12">
        {/* Left Side - Contact Info */}
        <div>
          <h2 className="text-2xl font-semibold mb-8 text-blue-700 text-center md:text-left">
            Talk to me
          </h2>
          <div className="space-y-6">
            {/* Email */}
            <div className="border rounded-xl p-6 flex items-center gap-4 border-white/20 shadow-lg shadow-blue-100 backdrop-blur-2xl">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border rounded-lg px-4 py-2 border-white/20 shadow-lg shadow-blue-100 backdrop-blur-2xl focus:ring-gray-400"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full md:w-auto bg-blue-600 text-white px-6 py-3 rounded-lg flex items-center justify-center gap-2 hover:bg-blue-500 transition"
            >
              Send Message
            </button>
          </form>
